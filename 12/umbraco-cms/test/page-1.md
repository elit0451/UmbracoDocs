...
However, it is also a complex feature. The query syntax quickly gets complicated, particularly when targeting block editors. You will likely need to experiment with some to get the query exactly right. Hopefully, the examples in this article will guide you in applying expansion and limiting to your own content.
